...
export type DAOProgram = {
  ...
  instructions: [
    ...
    },
    {
      ...
      discriminator: [224, 116, 67, 187, 156, 115, 244, 207];
      accounts: [
        {
          name: 'owner';
          writable: true;
    ...
    {
      name: 'payoutBounty';
      discriminator: [183, 17, 240, 215, 133, 209, 26, 166];
      accounts: [
        {
          name: 'initializer';
          writable: true;
    ...
    {
      name: 'setAllowSubDao';
      discriminator: [6, 136, 42, 35, 216, 146, 169, 142];
      accounts: [
        {
          name: 'initializer';
          writable: true;
    ...
    {
      name: 'setVetoCouncil';
      discriminator: [116, 82, 174, 69, 208, 27, 190, 244];
      accounts: [
        {
          name: 'initializer';
          writable: true;
  ...
  events: [
    {
      name: 'createDaoEvent';
      discriminator: [234, 103, 199, 8, 17, 156, 254, 178];
    }
  ];
  errors: [
    {
